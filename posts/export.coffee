...
for filename, postId in fs.readdirSync __dirname when filename.indexOf('20') is 0
  images = {}
  post = fs.readFileSync "#{__dirname}/#{filename}", 'utf8'
  ...
  if meta.npm?
    print """
      ...
      <wp:postmeta>
        ...
        <wp:meta_value><![CDATA[#{meta.npm.install or meta.npm.name}]]></wp:meta_value>
      </wp:postmeta>
      <wp:postmeta>
        <wp:meta_key>_module_name</wp:meta_key>
        <wp:meta_value><![CDATA[field_#{uuid(meta.npm.install or meta.npm.name)}]]></wp:meta_value>
      </wp:postmeta>
      <wp:postmeta>
        <wp:meta_key>module_github</wp:meta_key>
        <wp:meta_value><![CDATA[#{meta.npm.repo}]]></wp:meta_value>
      </wp:postmeta>
      <wp:postmeta>
        <wp:meta_key>_module_github</wp:meta_key>
        <wp:meta_value><![CDATA[field_#{uuid(meta.npm.repo)}]]></wp:meta_value>
      </wp:postmeta>
      <wp:postmeta>
        <wp:meta_key>module_license</wp:meta_key>
        <wp:meta_value><![CDATA[#{meta.npm.license}]]></wp:meta_value>
      </wp:postmeta>
      <wp:postmeta>
        <wp:meta_key>_module_license</wp:meta_key>
        <wp:meta_value><![CDATA[field_#{uuid(meta.npm.license)}]]></wp:meta_value>
      </wp:postmeta>
    """
    ...
    if meta.npm.install?
      print """
        <wp:postmeta>
          ...
          <wp:meta_value><![CDATA[#{meta.npm.name}]]></wp:meta_value>
        </wp:postmeta>
        <wp:postmeta>
          <wp:meta_key>_module_display_name</wp:meta_key>
          <wp:meta_value><![CDATA[field_#{uuid(meta.npm.name)}]]></wp:meta_value>
        </wp:postmeta>
      """
